...
var map_ServiceSpec = map[string]string{
	...
	"serviceIPFamily":          "The IPFamily value dictates the IPFamily of ClusterIP, LoadBalancerIP, Ingress IPs and Endpoints selected for this service. Default is ServiceIPFamilyClusterDefault",
}
